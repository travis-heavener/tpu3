...
| call          | label |    -- |   0x04 |       -- |      -- | Moves the IP to a named label's address, storing the current IP on the call stack. |
| ret           |    -- |    -- |   0x05 |       -- |      -- | Reverts the IP to the previous memory address stored on top of the call stack. |
