...
All memory after these first 4 bytes and before the first instruction bytes are reserved for the read-only .data section.
...
Everything after this is reserved for the heap.
